...
export default function About() {
  const itemsCard = [
    {
      img: <img className='section-about__content__card__img' src={cardAmazing} />,
    ...
    {
      img: <img className='section-about__content__card__img' src={cardReferrals} />,
    ...
    {
      img: <img className='section-about__content__card__img' src={cardFusion} />,
      title: 'FUSION',
    ...
    {
      img: <img className='section-about__content__card__img' src={cardRewards} />,
      title: 'REWARDS',
    ...
    {
      img: <img className='section-about__content__card__img' src={cardWar} />,
      title: 'WAR SECTOR',
    ...
    {
      img: <img className='section-about__content__card__img' src={cardBeacons} />,
      title: 'BEACONS',
    ...
    {
      img: <img className='section-about__content__card__img' src={cardStellar} />,
      title: 'stellar pass',
                ...
                <div className="section-about__content__card__text">
                  ...
                  <div className="section-about__content__card__utils">
                    <Octagon isDark className='about-play'>
                      {' '}
                      <a href="/" className="section-about__content__card__utils--play">
                        play
                      </a>{' '}
                    </Octagon>
                    <Octagon className='about-socials' isDark ><Socials /></Octagon>
                  </div>
                )}
                </div>
              </div>
